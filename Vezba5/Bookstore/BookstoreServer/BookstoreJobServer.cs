...
{
    class BookstoreJobServer
    {
        private ServiceHost serviceHost;

        private String externalEndpointName = "BookstoreInternalRequest";
        public BookstoreJobServer()
        {
           ...
           inputEndPoint.IPEndpoint, externalEndpointName);
            serviceHost = new ServiceHost(typeof(BookstoreJobServerProvider));
