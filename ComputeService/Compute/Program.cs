...
namespace Compute
{
    class Program
    {
        ...
        public static void CheckContainerCapacity(Packet packet)    // Proveriti logiku brisanja fajlova ako su zauzeti kontejneri. Da li brisati i iz liste ili samo direktorijuma
        {
